  ...
  return (
    <Frame>
      <div className="flex w-full flex-col items-center rounded-2xl border border-border bg-card p-8 text-center shadow-sm">
        ...
        {/* Download — client island that fetches the file via /api/d/{code}
            (which re-signs the underlying storage URL on each visit) and
            triggers a real "save as" dialog instead of opening the bytes
            in a new tab. */}
        <ShareDownloadButton
          code={share.shortCode}
